package javeriana.ms.multiplicador.bd;
...
import javeriana.ms.multiplicador.logs.Log;
import javeriana.ms.multiplicador.logs.ResponseLog;
...
public class MongoDB {
    ...
    public MongoDB() throws UnknownHostException {
        ...
        operationsDatabase = mongoClient.getDB("CalculatorOperations");
    }
